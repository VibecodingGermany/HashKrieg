...
{
    /// <summary>
    /// The counter triangle (.NET lane): the whole point of replacing the flat
    ...
    /// Mirror of the EditMode lane ArmorClassCounterTests.
    /// </summary>
    [TestFixture]
    public sealed class ArmorClassCounterTests
    {
