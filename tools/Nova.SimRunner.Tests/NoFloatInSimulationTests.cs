...
namespace Nova.SimRunner.Tests
{
    ...
    /// </para>
    /// Mirror of the EditMode lane NoFloatInSimulationTests.
    /// </summary>
    [TestFixture]
    public sealed class NoFloatInSimulationTests
    {
        ...
        /// <summary>
        /// THE ONE LANE-SPECIFIC METHOD. The EditMode mirror resolves the same
        /// directory from Application.dataPath; here the anchor is the test
        /// binary, so the scan works from any checkout path.
        /// </summary>
