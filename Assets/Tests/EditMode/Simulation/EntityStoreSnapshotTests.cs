...
{
    /// <summary>
    /// Entity store snapshot block v4 suite (EditMode lane): the Q-040(i)
    ...
    /// Mirror of the .NET lane EntityStoreSnapshotTests with Unity Test
    /// Framework asserts.
    /// </summary>
    [TestFixture]
    public class EntityStoreSnapshotTests
    {
