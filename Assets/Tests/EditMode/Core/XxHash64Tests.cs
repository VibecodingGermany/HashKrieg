...
namespace Nova.Core.Tests
{
    ...
    /// XxHash64Tests with Unity Test Framework asserts. Correctness is
    /// anchored on the official xxHash sanity test vectors (xxHash repository,
    /// tests/sanity_test_vectors.h, dev branch) using the official sanity
    /// buffer generator (XSUM_fillTestBuffer, cli/xsum_sanity_check.c).
    /// </summary>
    [TestFixture]
    public class XxHash64Tests
    {
        ...
        public void OfficialSanityVectors_MatchReference(int length, ulong seed, ulong expected)
        {
            ...
            Assert.AreEqual(expected, XxHash64.ComputeHash(buffer, seed));
        }
        ...
        public void ComputeHash_DefaultSeed_IsCanonicalSeed0()
        {
            ...
            Assert.AreEqual(
                XxHash64.ComputeHash(buffer, XxHash64.CanonicalSeed),
        ...
        public void Streaming_StripeBoundaries_MatchOneShot(int length)
        {
            ...
            foreach (int split in new[] { 9, length / 2 })
            {
                ...
                Assert.AreEqual(expected, state.Digest(), $"split {split}, length {length}");
            }
        }
        ...
        public void Streaming_OfficialVector_LargeBuffer_MatchesReference()
        {
            ...
            Assert.AreEqual(0xA82418DDEC0EA581UL, state.Digest());
        }
        ...
        public void Streaming_WithSeed_MatchesSeededOneShot()
        {
            ...
            Assert.AreEqual(expected, state.Digest());
        }
    }
}
