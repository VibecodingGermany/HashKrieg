...
**Version:** 1.12.1 | **Status:** aktiv (laufend) | **Verantwortungsbereich:** Executive Producer | **Sprint:** laufend (Stand 16–18)
...
| Q-044 | P2 | Halte-Feuer für ausgewählte Einheiten: „Stoppen" löscht seit D-094 zusätzlich den Angriffsbefehl (`UnitState.AttackTarget`), aber die Auto-Zielerfassung (D-087) erfasst im nächsten Tick neu. Ein echtes „Feuer einstellen" braucht einen Haltezustand in `Simulation/Combat/` und damit den externen Einheitenstrang. | D-094 | Sprint 13B | offen – liegt beim Einheitenstrang, als Befund zu übergeben |
