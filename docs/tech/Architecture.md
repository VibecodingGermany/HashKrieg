...
**Version:** 1.4.1 | **Status:** verbindlich für MS-1 – G0-A1 Mergekandidat, G0-A2 offen | **Verantwortungsbereich:** Lead Technical Director | **Sprint:** 7
...
| 1.4.1 | 2026-07-25 | G0-B-Interimsplatzierung der Prototyp-Selektions-/HUD-Logik in `Nova.Gameplay` aus der Plattform-Basis übernommen (Überführung nach `Nova.UI` mit G2) | Lead Technical Director |
